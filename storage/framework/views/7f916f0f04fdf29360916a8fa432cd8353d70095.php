		...
		<div class="Rectangle_38">
			<div class="front-board">
				<center><a href="/product-details/<?php echo e($dt->prod_id); ?>" class="prod-image-click">
					<img src="img/shop/<?php echo e($dt->image1); ?>" alt="featured" class="prod-image-slide">
				</a></center><br><br>
...
</html><?php /**PATH F:\Office\Web Development\CartGo\resources\views/index.blade.php ENDPATH**/ ?>