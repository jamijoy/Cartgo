...
<div id="relate_Page">
	...
	<div class="product-main-display">
		...
		<?php if(session()->has('msg')): ?>
			<p class="confirm-data"><?php echo e(session()->get('msg')); ?></p><br><br>
		  ...
		  <div class="container">
		    <div class="row">
		      ...
		      <div class="col-sm-6 col-md-5">
		        <div class="login">
		          <form id="accountform" action="/AddProduct" enctype="multipart/form-data" method="post" name="reg"><?php echo csrf_field(); ?>
...
</html><?php /**PATH F:\Office\Web Development\CartGo\resources\views/addDetails.blade.php ENDPATH**/ ?>