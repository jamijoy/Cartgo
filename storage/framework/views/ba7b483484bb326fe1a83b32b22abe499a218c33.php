...
<div id="Supplier_Form">
	...
	<div id="reg_form">
		...
		<form id="signup-form" action="/reg" method="post" name="reg">
			<?php echo csrf_field(); ?>
			<p class="err-data"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $err): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php echo e($err); ?> <br>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></p>
			<p id="unameLbl">Username<span>*</span></p>
			<input type="text" name="username" class="field_acc" onkeyup="unameChk('<?php echo e(csrf_token()); ?>')" />
			
			<div class="col-sm-6">
				<p id="emailLbl">E-mail Address<span>*</span></p>
				<input type="text" name="email" class="field_acc" onkeyup="emailChk('<?php echo e(csrf_token()); ?>')"/>
			</div>
			<div class="col-sm-6">
				<p id="contactLbl">Contact Number<span>*</span></p>
				<input type="text" name="contact" class="field_acc" onkeyup="contactChk('<?php echo e(csrf_token()); ?>')"/>
			</div><br><br><br>
			<div class="col-sm-6">
			...
			<input type="password" class="field_acc" name="pass1" onkeyup="passChk('<?php echo e(csrf_token()); ?>')" />
	...
	<?php echo $__env->yieldContent('footer-sup'); ?>
	
</div>
</body>
</html><?php /**PATH F:\Office\Web Development\CartGo\resources\views/register.blade.php ENDPATH**/ ?>